...
import './App.css';
import MemeDetail from './components/ScreenshotDetail';
import MemeList from './components/ScreenshotList';
...
class App extends React.Component<{}, IState> {
	...
	private fetchMemes(tag: any) {
		let url = "http://jdez501memeapi.azurewebsites.net/api/meme"
		if (tag !== "") {
			url += "/tag?=" + tag
		}
		fetch(url, {
	...
	private uploadMeme() {
		...
		const url = "http://jdez501memeapi.azurewebsites.net/api/meme/upload"
